	...
	for(key in data){
		userTable+= "<tr id='row"+key+"'><td>" + key + "</td><td><input type='text' value='" + data[key]['username'] + "'></td><td><input type='text' value='" + data[key]['phone'] + "'></td><td><input type='text' value='" + data[key]['email'] + "'></td><td>";
